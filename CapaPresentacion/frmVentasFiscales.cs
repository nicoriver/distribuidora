...
namespace CapaPresentacion
{
    public partial class frmVentasFiscales : Form
    {
        ...
        {
            // Configurar fecha a d√≠a anterior
        ...
        private void cboTipoComprobante_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            ActualizarNumeroDocumento();  // ? Agregar esta lÌnea
            ...
            if (dgvProductos.Rows.Count > 1)
            {
                var result = MessageBox.Show(
                    "Al cambiar el tipo de comprobante se limpiaran los productos. øContinuar?",
                    "Advertencia",
        ...
        private void BuscarYCargarProducto(int rowIndex, string codigo)
        {
            ...
            if (producto == null)
            {
                MessageBox.Show($"Producto con c√≥digo '{codigo}' no encontrado", "Producto no encontrado",
                    MessageBoxButtons.OK, MessageBoxIcon.Warning);
                dgvProductos.Rows[rowIndex].Cells["Codigo"].Value = "";
                return;
            }

            // Obtener precio seg√∫n lista
            string mensaje;
        ...
        private void dgvProductos_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (columnName == "Codigo")
                {
                    // Ya se proces√≥ en CellEndEdit, mover a cantidad
                ...
                {
                    // Agregar nueva fila y mover a c√≥digo
                    if (dgvProductos.Rows[currentRow].Cells["Producto"].Value != null)
                    {
                        AgregarFilaVacia();
        ...
        private void btnGuardarVenta_Click(object sender, EventArgs e)
        {
            ...
            Venta venta = new Venta()
            {
                ...
                // NumeroDocumento = string.Format("{0:00000}", _NumeroComprobanteActual), // Solo el n√∫mero
                NumeroDocumento = string.Format("{0:00000}", Convert.ToInt32(txtNumeroDocumento.Text)), // Solo el n√∫mero
            ...
            if (resultado)
            {
                // Guardar n√∫mero de documento antes de limpiar
        ...
        private void ImprimirComprobanteActual(Venta venta, DataTable detalle)
        {
            try
            {
                ...
                {
                    // Buscar el producto en el grid para obtener c√≥digo y nombre
        ...
        private void ActualizarNumeroDocumento()
        {
            ...
            try
            {
                ...
                // Obtener siguiente n˙mero para este tipo de comprobante y punto de venta
                int numeroDocumento = new CN_Venta().ObtenerCorrelativoPorTipo(
                    _TipoComprobanteSeleccionado.IdTipoComprobante,
                    puntoVenta);

                // Actualizar el label o textbox donde muestras el n˙mero
                // Ajusta seg˙n tu formulario:
            ...
            {
                MessageBox.Show($"Error al obtener n˙mero de documento: {ex.Message}",
                    "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void cboPuntoVenta_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            // AquÌ puedes actualizar el n˙mero de documento si lo necesitas
        }
        ...
        private void txtIdCliente_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                // Verificar que haya un ID v·lido
