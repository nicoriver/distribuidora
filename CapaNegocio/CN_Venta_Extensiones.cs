...
namespace CapaNegocio
{
    ...
    /// Estos métodos deben agregarse a la clase CN_Venta existente
    /// </summary>
    public partial class CN_Venta_Extensiones
    {
        ...
        public Venta ObtenerVentaPorNumeroDocumento(string numeroDocumento, out string mensaje)
        {
            ...
            try
            {
                ...
                if (venta == null)
                {
                    mensaje = "No se encontró el comprobante especificado";
                    return null;
                }
                ...
                {
                    mensaje = "No se puede crear una nota de crédito de otra nota de crédito";
                    return null;
                }
        ...
        // =============================================
        // MÉTODO 2: Obtener Detalle de Venta
        // =============================================
        public List<Detalle_Venta> ObtenerDetalleVenta(int idVenta, out string mensaje)
        {
            ...
            try
            {
                ...
                {
                    mensaje = "No se encontró detalle para la venta especificada";
        ...
        public int RegistrarNotaCredito(Venta notaCredito, List<Detalle_Venta> detalle, out string mensaje)
        {
            ...
            try
            {
                ...
                if (notaCredito == null)
                {
                    mensaje = "Los datos de la nota de crédito son requeridos";
                    return 0;
                }
                ...
                if (idNotaCredito == 0)
                {
                    // El mensaje ya viene del método de datos
                    return 0;
                }

                mensaje = "Nota de crédito registrada exitosamente";
            }
            catch (Exception ex)
            {
                mensaje = "Error al registrar la nota de crédito: " + ex.Message;
                idNotaCredito = 0;
            }
        ...
        public int DeterminarTipoNotaCredito(int idTipoComprobanteOriginal, out string mensaje)
        {
            ...
            try
            {
                ...
                {
                    mensaje = "El tipo de comprobante original no es válido";
                    return 0;
                }
                ...
                if (idTipoNC == 0)
                {
                    mensaje = "No se pudo determinar el tipo de nota de crédito";
                    return 0;
                }

                mensaje = "Tipo de nota de crédito determinado exitosamente";
            }
            catch (Exception ex)
            {
        ...
        // =============================================
        // MÉTODO 6: Validar Cantidades de Devolución
        // =============================================
        ...
        // =============================================
        // MÉTODO 7: Calcular Totales de NC
        // =============================================
        ...
        // =============================================
        // MÉTODO 8: Obtener Descripción de Tipo de NC
        // =============================================
