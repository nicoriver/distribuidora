...
{
    public partial class mdPreciosLista : FormularioBase
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                MostrarError("Seleccione un tipo de lista");
                return;
            }
            ...
            {
                MostrarError("Ya existe una lista de tipo " + ObtenerNombreTipoLista(tipoListaSeleccionado) + " para este producto.");
                return;
            }
            ...
            if (resultado != 0)
            {
                MostrarExito("Precio guardado correctamente");
                CargarPrecios();
            }
            else
            {
        ...
        private void dgvPrecios_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                if (SolicitarConfirmacion("¿Desea eliminar este precio de lista?"))
                {
                    ...
                    if (resultado)
                    {
                        MostrarExito("Precio eliminado correctamente");
                        CargarPrecios();
                    }
                    else
                    {
